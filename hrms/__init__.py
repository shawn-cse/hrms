...
# Patch makemigrations and migrate to use HRMSAutodetector.
#
...
try:
    ...
    from hrms.inherit.autodetect import HRMSAutodetector

    _MM.autodetector = HRMSAutodetector
    _Migrate.autodetector = HRMSAutodetector
except ImportError:
    pass

from hrms.__version__ import __version__  # noqa: E402,F401
