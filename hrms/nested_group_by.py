...
from hrms.group_by import _page_from_list, _page_of_groupers, _resolve_fk_groupers
from hrms.hrms_middlewares import _thread_locals


def _ordered_keep_none(values):
    """
    Like hrms.group_by._ordered_unique, but keeps None as its own
...
def nested_group_by_queryset(
    ...
    def build_level(prefix_key, combos_here, level, dynamic_prefix):
        ...
        for value in ordered_values:
            ...
            # pagination (mirrors hrms/group_by.py's convention, where
