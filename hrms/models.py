...
This module defines the abstract base model `HRMSModel` for the HRMS project.
...
class HRMSModel(models.Model, metaclass=HRMSModelBase):
    """
    ...
    def save(self, *args, **kwargs):
        ...
        if request:
            ...
            if (
                ...
                and self._meta.get_field("created_by").related_model == HRMSUser
            ):
