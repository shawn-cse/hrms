"""
hrms/inherit/model_inherit.py

HRMSModelBase — metaclass for HRMSModel that enables field and method
...
Usage in an extension app:
    ...
    class AssetExtension(HRMSModel):
...
to the extension app via INJECTION_MAP + HRMSAutodetector.
"""
...
class HRMSModelBase(ModelBase):
    """
    Metaclass for HRMSModel.
