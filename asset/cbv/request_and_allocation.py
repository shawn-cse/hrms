...
@method_decorator(login_required, name="dispatch")
class AllocationList(HRMSListView):
    """
    ...
    # classic and nested grouping branches in HRMSListView).
...
@method_decorator(login_required, name="dispatch")
class AssetRequestList(HRMSListView):
    """
    Asset Request Tab
    """
    ...
    def get_queryset(self):
        ...
        # (not popped) since HRMSListView calls get_queryset() more than
...
@method_decorator(login_required, name="dispatch")
class RequestAndAllocationTab(HRMSTabView):
    """
    Tab View
    """
...
class _RequestAndAllocationNavBase(HRMSNavView):
    """
...
class AssetDetailView(HRMSDetailedView):
    """
...
class AssetRequestDetailView(HRMSDetailedView):
    """
...
class AssetAllocationDetailView(HRMSDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetRequestCreateForm(HRMSFormView):
    """
...
class AssetAllocationFormView(HRMSFormView):
    """
...
class AssetApproveFormView(HRMSFormView):
    """
    Create Asset Allocation
    """
...
class AssetRenewalNav(HRMSNavView):
    """
...
class ExpiringAssignmentList(HRMSListView):
    """
...
class AssetReassignFormView(HRMSFormView):
    """
