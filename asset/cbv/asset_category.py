...
from hrms_views.views import HRMSDeleteConfirmationView


@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetcategory"), name="dispatch")
class AssetCategoryFormView(HRMSFormView):
    """
...
class AssetFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetcategory"), name="dispatch")
class AssetCategoryDuplicateFormView(HRMSFormView):
    """
...
class AssetDuplicateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetReportFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_asset"), name="dispatch")
class AssetCategoryListView(HRMSListView):
    """
    ...
    the asset CRUD forms) so the standard HRMSListView group-by engine can
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_asset"), name="dispatch")
class AssetCategoryNav(HRMSNavView):
    """
...
class AssetDeleteConfirmationView(HRMSDeleteConfirmationView):
    ...
    def post(self, *args, **kwargs):
        ...
        return HRMSFormView.HttpResponse(targets_to_reload=[".filterButton"])
