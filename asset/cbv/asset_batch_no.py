...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetlot"), name="dispatch")
class AssetBatchNoListView(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetlot"), name="dispatch")
class AssetBatchNoNav(HRMSNavView):
    """
    Nav bar
    """
...
class AssetBatchCreateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetlot"), name="dispatch")
class AssetBatchDetailView(HRMSDetailedView):
    """
