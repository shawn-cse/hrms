...
from hrms_views.generic.cbv.views import HRMSDetailedView, HRMSListView


@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_asset"), name="dispatch")
class AssetListView(HRMSListView):
    """
    ...
    def get_queryset(self, queryset=None, filtered=False, *args, **kwargs):
        ...
        # since HRMSListView calls get_queryset() more than once per
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_asset"), name="dispatch")
class AssetInformationView(HRMSDetailedView):
    """
