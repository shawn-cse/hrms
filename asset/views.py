...
def add_asset_report(request, asset_id=None):
    ...
    if asset_id:
        ...
        if not asset:
            return HRMSRedirect(request, message=_("Asset not found"))
...
def asset_category_view(request):
    ...
    standard HRMSViews nav/list pair (asset.cbv.asset_category
...
def own_asset_individual_view(request, asset_id):
    ...
    if not asset_assignment:
        return HRMSRedirect(request, message=_("Asset assignment not found"))
            ...
            for field in fields_to_check:
                ...
                if isinstance(value, date):
                    ...
                    for (
                        format_name,
                        format_string,
                    ) in settings.HRMS_DATE_FORMATS.items():
