...
from hrms_widgets.forms import HRMSForm, default_select_option_template
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.request = getattr(hrms_middlewares._thread_locals, "request", None)
        ...
        if type_ == "bonus_encashment":
            ...
            if not leave_type:
                ...
                if leave_type not in encashable:
                    ...
                    AvailableLeave = get_hrms_model_class("leave", "availableleave")
...
class PayslipAutoGenerateForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        active_company_id = hrms_middlewares.get_selected_company()
