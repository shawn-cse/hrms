...
class FederalTaxFormView(HRMSFormView):
    """
...
class FilingStatusDetailView(HRMSDetailedView):
    """
...
class TaxBracketCreateForm(HRMSFormView):
    """
...
class TaxBracketNavView(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_taxbracket"), name="dispatch")
class TaxBracketListView(HRMSListView):
    """
