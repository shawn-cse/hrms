...
@method_decorator(login_required, name="dispatch")
class ReimbursementsAndEncashmentsTabView(HRMSTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsAndEncashmentsListView(HRMSListView):
    """
    list view
    """
...
class _ReimbursementTabNavBase(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsDetailView(HRMSDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsFormView(HRMSFormView):
    """
