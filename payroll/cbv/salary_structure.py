...
class SalaryStructureListView(HRMSListView):
    """
...
class SalaryStructureNavView(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class DynamicAllowanceCreateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class DynamicDeductionCreateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class SalaryStructureFormView(HRMSFormView):
    """
...
class SalaryStructureFormDuplicate(HRMSFormView):
    """
...
class SalaryStructureDetailView(HRMSDetailedView):
    """
...
class AllowanceDuplicateInStructureView(HRMSFormView):
    """
...
class DeductionDuplicateInStructureView(HRMSFormView):
    """
