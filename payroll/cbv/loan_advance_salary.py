...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_loanaccount"), name="dispatch")
class LoansGenericTab(HRMSTabView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_loanaccount"), name="dispatch")
class LoanListView(HRMSListView):
    """
...
class _LoanTabNavBase(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_loanaccount"), name="dispatch")
class LoanDetailView(HRMSDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_loanaccount"), name="dispatch")
class LoanFormView(HRMSFormView):
    """
