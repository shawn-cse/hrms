...
from hrms.filters import HRMSFilterSet, filter_by_name
...
class ContractFilter(HRMSFilterSet):
    """
...
class AllowanceFilter(HRMSFilterSet):
    """
...
class DeductionFilter(HRMSFilterSet):
    """
...
class SalaryStructureFilter(HRMSFilterSet):
    """
...
class PayslipFilter(HRMSFilterSet):
    """
...
class LoanAccountFilter(HRMSFilterSet):
    """
    LoanAccountFilter
    """
...
class ReimbursementFilter(HRMSFilterSet):
    """
    ReimbursementFilter
    """
...
class TaxBracketFilter(HRMSFilterSet):
    """
...
class FilingStatusFilter(HRMSFilterSet):
    """
    Filter set class for TaxBracket model.
    """
...
class PayslipAutoGenerateFilter(HRMSFilterSet):
