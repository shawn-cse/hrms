...
class Tour(HRMSModel):
    ...
    def get_update_url(self):
        """Edit URL — consumed by HRMSListView row actions."""
...
class TourStep(HRMSModel):
    ...
    objects = HRMSCompanyManager("tour__company_id")
