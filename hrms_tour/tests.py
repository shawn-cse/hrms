"""
Tests for the hrms_tour engine.
...
from hrms.hrms_middlewares import set_selected_company
...
class TourPermissionTests(TestCase):
    def setUp(self):
        self.client = Client()
        self.regular = HRMSUser.objects.create_user(
...
class TourCompanyIsolationTests(TestCase):
    def setUp(self):
        ...
        # HRMSModel.save() doesn't stamp modified_by with a stale user id.
