...
from hrms_meet.methods import get_google_credentials
from hrms_meet.models import *
...
@login_required
@permission_required("hrms_meet.delete_googlecloudcredentials")
...
@login_required
@permission_required("hrms_meet.add_googlemeeting")
@check_integration_enabled(app_name="hrms_meet")
...
@login_required
@permission_required("hrms_meet.delete_googlemeeting")
@check_integration_enabled(app_name="hrms_meet")
