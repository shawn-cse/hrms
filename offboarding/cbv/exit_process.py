...
class OffboardingStageFormView(HRMSFormView):
    """
...
class OffboardingStageAddEmployeeForm(HRMSFormView):
    """
    form view for create button
    """
...
class OffboardingCreateFormView(HRMSFormView):
    """
...
class OffboardingTaskFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class ExitProcessDetailView(HRMSDetailedView):
    """
    detail view
    """
...
class OffboardingPipelineView(HRMSSectionView):
    """
...
class OffboardingPipelineNav(HRMSNavView):
    """
    ...
    def get_context_data(self, **kwargs):
        ...
        # auto-submits it on every load (see hrms_nav.html), serializing
...
class PipeLineTabView(HRMSTabView):
    """
    Pipeline Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingKanbanView(HRMSKanbanView):
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingEmployeeList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class DashboardTaskListview(HRMSListView):
    """
...
if apps.is_installed("asset"):
    ...
    class DashboardNotReturndAsssets(HRMSListView):
        """
        For dashboard task status table
        """
...
if apps.is_installed("pms"):
    ...
    class DashboardFeedbackView(HRMSListView):
        """
        For dashboard task status table
        """
        ...
        def __init__(self, *args, **kwargs):
            self.Feedback = get_hrms_model_class(app_label="pms", model="feedback")
