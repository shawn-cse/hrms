...
class ResignationListView(HRMSListView):
    """
    list view
    """
...
class ResinationLettersNav(HRMSNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ResignationLettersFormView(HRMSFormView):
    """
...
class ResignationLetterDetailView(HRMSDetailedView):
    """
