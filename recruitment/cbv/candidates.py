...
class ListCandidates(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="recruitment.view_candidate"), name="dispatch")
class CardCandidates(HRMSCardView):
    """
    For card view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="recruitment.view_candidate"), name="dispatch")
class CandidateNav(HRMSNavView):
    """
    For nav bar
    """
...
class CandidateDetail(HRMSDetailedView):
    """
    Candidate detail
    """
...
class ToSkillZoneFormView(HRMSFormView):
    """
    Form View
    """
...
class RejectReasonFormView(HRMSFormView):
    """
    Form View
    """
