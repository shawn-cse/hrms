    ...
    def get_queryset(self):
        ...
        queryset = (
            ...
            .prefetch_related(
                ...
                # (HRMSCompanyManager), but prefetch_related builds its batch
...
class StageFormView(HRMSFormView):
    """
    Form View
    """
...
class StageDuplicateForm(HRMSFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="recruitment.view_stage"), name="dispatch")
class StageDetailView(HRMSDetailedView):
    """
    detail view of page
    """
