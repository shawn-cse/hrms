...
class QuestionFormView(HRMSFormView):
    """
...
class QuestionDuplicateFormView(HRMSFormView):
    """
...
class SurveyTemplateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class RecruitmentSurveyDetailView(HRMSDetailedView):
    """
...
class SurveyTemplateTabView(HRMSTabView):
    """
...
class SurveyTemplateNavView(HRMSNavView):
    """
...
class SurveyQuestionNavView(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class SurveyTemplateQuestionsTab(HRMSTabView):
    """
...
@method_decorator(login_required, name="dispatch")
class SurveyTemplateList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class SurveyQuestionList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class SurveyTemplateNav(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class SurveyQuestionNav(HRMSNavView):
    """
