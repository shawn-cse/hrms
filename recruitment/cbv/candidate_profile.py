...
from hrms_views.generic.cbv.views import HRMSListView, HRMSProfileView
...
class CandidateProfileView(HRMSProfileView):
    """
...
class CandidateProfileTasks(HRMSListView):
    """
