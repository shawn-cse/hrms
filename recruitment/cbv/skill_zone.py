...
class SkillZoneFormView(HRMSFormView):
    """
...
class SkillZoneCandidateFormView(HRMSFormView):
    """
...
class SkillZoneProfileListView(HRMSListView):
    """
    ...
    def __init__(self, **kwargs):
        ...
        # all hx-target="#{{view_id}}" from generic/hrms_list_table.html -
    ...
    def get_template_names(self):
        if self.request.headers.get("HX-Target") == self.view_id:
            return ["generic/hrms_list_table.html"]
