...
class RecruitmentList(HRMSListView):
    """
...
class RecruitmentNav(HRMSNavView):
    """
    For nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class RecruitmentNewSkillForm(HRMSFormView):
    """
...
class RecruitmentForm(HRMSFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class AddCandidateFormView(HRMSFormView):
    """
...
class RecruitmentFormDuplicate(HRMSFormView):
    """
    Duplicate form view
    """
...
class RecruitmentDetailView(HRMSDetailedView):
    """
    detail view of page
    """
