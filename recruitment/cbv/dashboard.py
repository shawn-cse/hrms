...
class SkillZoneStatusList(HRMSListView):
    """
...
class CandidateOnOnboardList(HRMSListView):
    """
...
class CurrentHiringList(HRMSListView):
    """
...
class OnGoingRecruitmentList(HRMSListView):
    """
