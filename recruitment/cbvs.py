...
class LinkedinSettingSectionView(views.HRMSSectionView):
    """
...
class LinkedInSettingNavView(views.HRMSNavView):
    """
...
class LinkedInAccountFormView(views.HRMSFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.HRMSListView):
    """
