...
class CandidateFilter(HRMSFilterSet):
    """
...
class CandidateDocumentFilter(HRMSFilterSet):
    """
...
class SkillZoneCandidateFilter(HRMSFilterSet):
    """
...
class RecruitmentFilter(HRMSFilterSet):
    """
...
class StageFilter(HRMSFilterSet):
    """
...
class SurveyFilter(HRMSFilterSet):
    """
    SurveyFIlter
    """
...
class SkillZoneCandFilter(HRMSFilterSet):
    """
...
class InterviewFilter(HRMSFilterSet):
    """
    Filter set class for Candidate model
