...
from hrms.decorators import check_integration_enabled
...
class CredentialListView(HRMSListView):
    """
...
@method_decorator(check_integration_enabled(app_name="whatsapp"), name="dispatch")
class CredentialNav(HRMSNavView):
    """
...
@method_decorator(check_integration_enabled(app_name="whatsapp"), name="dispatch")
class CredentialForm(HRMSFormView):
    """
