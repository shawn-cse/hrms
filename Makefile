...
db-shell: ## Open PostgreSQL shell
	$(COMPOSE) exec db psql -U hrms_user -d hrms_db
...
SMOKE_LABELS ?= leave attendance base hrms_auth employee accessibility payroll hrms_api biometric asset recruitment onboarding offboarding pms project helpdesk report whatsapp facedetection geofencing hrms_documents hrms_automations hrms_backup hrms_crumbs hrms_ldap hrms_meet hrms_theme hrms_widgets hrms_views hrms_audit
...
COV_FAIL_UNDER ?= 5
COV_SOURCE ?= leave,attendance,base,payroll,recruitment,report,hrms_auth,employee,accessibility,hrms_api
