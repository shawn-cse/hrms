...
def _load():
    ...
    register(
        ReportDefinition(
            ...
            permission="employee.view_employee",
            alt_permissions=("hrms_audit.view_audittag",),
    ...
    register(
        ReportDefinition(
            ...
            domain="compliance",
            description=_(
                "Overdue and upcoming hrms_documents expiry buckets (90-day horizon)."
            ),
            permission="employee.view_employee",
            alt_permissions=("hrms_documents.view_document",),
            query_fn=packs.document_expiry_aging,
            export_model="employee.Employee",
            required_apps=("employee", "hrms_documents"),
