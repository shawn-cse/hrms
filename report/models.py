...
class ReportTemplate(HRMSModel):
    """
...
class ReportSubscription(HRMSModel):
    """
...
class ReportFavorite(HRMSModel):
...
class ReportSavedView(HRMSModel):
    """
...
class ReportFilterPreset(HRMSModel):
...
class ReportRunLog(HRMSModel):
    ...
    def employee_label(self) -> str:
        ...
        HRMSUser username — more recognizable to HR admins reading the
