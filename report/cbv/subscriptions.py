...
def _subscription_actions():
    ...
    hrms_detailed_view.html and hrms_list_table.html, both do
...
@method_decorator(login_required, name="dispatch")
class ReportSubscriptionsNav(HRMSNavView):
...
@method_decorator(login_required, name="dispatch")
class ReportSubscriptionsListView(HRMSListView):
    """
    ...
    # hrms_views/templates/generic/hrms_list_table.html lines 32-34 /
    ...
    def get_queryset(self, queryset=None, filtered=False, *args, **kwargs):
        # HRMSListView's base get_queryset() ultimately calls the manager's
        # .all(), which auto-hides is_active=False rows (HRMSCompanyManager
...
@method_decorator(login_required, name="dispatch")
class ReportSubscriptionFormView(HRMSFormView):
    """
    Real HRMS create/edit form component (base.forms.ModelForm +
...
@method_decorator(login_required, name="dispatch")
class ReportSubscriptionDetailView(HRMSDetailedView):
    """Real HRMS detailed-view component — opened by clicking a row on
