 ...
 * by loading this script and calling HRMSReportExport.exportTable(...).
 *
 * Usage (theme report templates):
 *   <script src="{% static 'report/js/report_export.js' %}"></script>
 *   HRMSReportExport.exportTable(tableEl, { format: 'xlsx', filename: 'report.xlsx' });
 */
(function (global) {
  "use strict";
