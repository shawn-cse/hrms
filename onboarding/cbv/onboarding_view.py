...
from hrms_views.generic.cbv.views import HRMSDetailedView, HRMSFormView
...
class StageCreateForm(HRMSFormView):
    """
...
class TaskCreateForm(HRMSFormView):
    """
...
class TaskUpdateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class OnboardingCandidateDetailView(HRMSDetailedView):
    """
