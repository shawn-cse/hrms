...
from hrms.testkit import make_company, make_employee
...
class OnboardingStagePipelineWidgetTests(TestCase):
    def setUp(self):
        ...
        self.admin = User.objects.create_superuser(
            ...
            email="stage-pipeline-admin@test.hrms",
            password="pass",
        )
        make_employee(
            company=self.company,
            email="stage-pipeline-admin-profile@test.hrms",
            user=self.admin,
        )
        self.client = Client()
        ...
        self.candidates = [
            Candidate.objects.create(
                ...
                email=f"stage-cand-a{i}@test.hrms",
