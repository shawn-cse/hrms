...
from hrms_views.generic.cbv import history
...
urlpatterns = [
    ...
    path(
        "generic-delete/",
        views.HRMSDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "hrms-history-revert/<int:pk>/<int:history_id>/",
        history.HRMSHistoryView.as_view(),
        name="history-revert",
    ),
    path(
