"""
hrms_views/generic/cbv/history.py
"""
...
from hrms_views.history_methods import get_diff


@method_decorator(login_required, name="dispatch")
@method_decorator(hx_request_required, name="dispatch")
class HRMSHistoryView(DetailView):
    """
    GenericHRMSHistoryView
    """

    template_name = "generic/hrms_history_view.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        elif hasattr(instance, "hrms_history"):
            context["tracking"] = None
            context["log_entries"] = instance.hrms_history.all().order_by(
                "-timestamp"
            )
        else:
            context["tracking"] = tracking
