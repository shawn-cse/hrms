"""
hrms_views/generic/cbv/kanban.py
"""

from django.core.paginator import EmptyPage, PageNotAnInteger, Paginator
from django.db import models

from hrms_views.cbv_methods import get_nested_field
from hrms_views.generic.cbv.views import HRMSCardView


class HRMSKanbanView(HRMSCardView):
    group_key: str = ""
    group_filter_class = None
    template_name: str = "generic/hrms_kanban_view.html"
    kanban_attrs: str = ""
