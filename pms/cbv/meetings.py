...
@method_decorator(login_required, name="dispatch")
class MeetingsList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsDetailedView(HRMSDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsFormView(HRMSFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingResponseFormView(HRMSFormView):
    """
    Form View
    """
