...
from hrms_views.generic.cbv.views import HRMSTabView, TemplateView
...
@method_decorator(login_required, name="dispatch")
class PerformanceSettingsTabView(HRMSTabView):
    """
...
# this settings tab. This is necessary because HRMSTabView keeps every
