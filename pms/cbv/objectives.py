...
@method_decorator(login_required, name="dispatch")
class ObjectivesList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class ObjectivesTab(HRMSTabView):
    """
    Tab View
    """
...
class _ObjectivesTabNavBase(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class CreateEmployeeObjectiveForm(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class CreateObjectiveFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class AddAssigneesFormView(HRMSFormView):
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if not obj_id:
            return HRMSRedirect(request, message=_("Objective ID is missing"))

        self.object = Objective.objects.filter(pk=obj_id).first()

        if not self.object:
            return HRMSRedirect(request, message=_("Invalid Objective"))
...
@method_decorator(login_required, name="dispatch")
class CreateEmployeeKeyResultFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeObjectiveDetailView(HRMSDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeObjectiveKeyResultDetailListView(HRMSListView):
    """
    List view of the page
    """
...
class EKRTab(EmployeeObjectiveKeyResultDetailListView):
    ...
    def get_queryset(self, queryset=None, filtered=False, *args, **kwargs):
        self.queryset = HRMSListView.get_queryset(
