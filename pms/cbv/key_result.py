...
from hrms_views.generic.cbv.history import HRMSHistoryView
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultNavView(HRMSNavView):
    """
    navbar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultsListView(HRMSListView):
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultCardView(HRMSCardView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultsDetailedView(HRMSDetailedView):
    """
    Detail View
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class EKRHistory(HRMSHistoryView):
    """
    EKR History
    """
