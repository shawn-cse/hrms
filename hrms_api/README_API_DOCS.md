...
This document provides information on how to use and maintain the API documentation for HRMS.
...
```python
from hrms_api.docs import document_api
...
- Module tags are defined in `hrms_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `hrms_api/urls.py`
