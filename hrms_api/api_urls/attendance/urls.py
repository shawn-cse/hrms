"""
hrms_api/urls/attendance/urls.py
"""

from django.urls import path

from hrms_api.api_views.attendance.permission_views import AttendancePermissionCheck
from hrms_api.api_views.attendance.views import *
