...
class ProjectStage(HRMSModel):
    ...
    objects = HRMSCompanyManager("project__company_id")
...
class TimeSheet(HRMSModel):
    ...
    objects = HRMSCompanyManager("project_id__company_id")
