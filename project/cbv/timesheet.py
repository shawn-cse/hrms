...
class TimeSheetNavView(HRMSNavView):
    """
    Nav bar
    """
...
class TimeSheetList(HRMSListView):
    """
...
class TimeSheetFormView(HRMSFormView):
    """
...
class TimeSheetCardView(HRMSCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(HRMSDetailedView):
    """
