"""
Configuration for hrms_dbtemplate.

Reads from Django settings with HRMS_DBTEMPLATE_* prefix.
...
def get_setting(name, default=None):
    """Get a setting with HRMS_DBTEMPLATE_ prefix."""
    full_name = f"HRMS_DBTEMPLATE_{name}"
    return getattr(settings, full_name, default)


# Cache backend name from CACHES (e.g. "default" or "hrms_dbtemplate")
