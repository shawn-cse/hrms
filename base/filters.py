...
from hrms.filters import FilterSet, HRMSFilterSet, filter_by_name


class ShiftRequestFilter(HRMSFilterSet):
    """
...
class WorkTypeRequestFilter(HRMSFilterSet):
    """
...
class RotatingShiftAssignFilters(HRMSFilterSet):
    """
...
class RotatingWorkTypeAssignFilter(HRMSFilterSet):
    """
...
class MultipleApprovalConditionFilter(HRMSFilterSet):
...
class RotatingShiftFilter(HRMSFilterSet):
...
class DepartmentViewFilter(HRMSFilterSet):
...
class WorkTypeFilter(HRMSFilterSet):
...
class RotatingWorkTypeFilter(HRMSFilterSet):
...
class JobRoleFilter(HRMSFilterSet):
    search = django_filters.CharFilter(method="filter_by_all_fields")
...
class MailServerFilter(HRMSFilterSet):
...
class HolidayFilter(HRMSFilterSet):
    """
...
class CompanyLeaveFilter(HRMSFilterSet):
    """
...
class MailLogFilter(HRMSFilterSet):
...
class AnnouncementFilter(HRMSFilterSet):
...
class AnnouncementViewFilter(HRMSFilterSet):
