...
from hrms.hrms_middlewares import _thread_locals, set_selected_company
from hrms.methods import get_hrms_model_class
from hrms_documents.models import DocumentRequest

CACHE_KEY = "hrms_company_models_cache_key"
...
#         is_hrms_manager = isinstance(model.objects, HRMSCompanyManager)
...
#             elif is_hrms_manager and related_company_field:
#                 model.add_to_class(
...
#                         [get_hrms_model_class(app_label, model) for model in models]
#                     )
...
class CompanyMiddleware:
    ...
    def __call__(self, request):
        ...
        try:
            ...
            # left here outlives its own lifecycle. HRMSModel.save() reads it
