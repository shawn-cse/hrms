...
class AssignPermission(Form):
    ...
    def save(self):
        ...
        users = HRMSUser.objects.filter(id__in=user_ids)
        for user in users:
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = HRMSMultiSelectField(
        queryset=Department.objects.all(),
...
class ChangeUsernameForm(forms.Form):
    ...
    def clean_password(self):
        ...
        if HRMSUser.objects.filter(username=username).exists():
...
class AnnouncementForm(ModelForm):
    ...
    employees = HRMSMultiSelectField(
        queryset=Employee.objects.all(),
        widget=HRMSMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], HRMSMultiSelectField):
...
class PassWordResetForm(forms.Form):
    ...
    def save(
        ...
        user = HRMSUser.objects.get(username=username)
