...
class JobPositionListView(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_jobposition"), name="dispatch")
class JobPositionNavView(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_jobposition"), name="dispatch")
class JobPositionDetailView(HRMSDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_jobposition"), name="dispatch")
class JobPositionCreateForm(HRMSFormView):
    """
