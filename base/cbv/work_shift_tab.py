...
from hrms_views.generic.cbv.views import HRMSNavView, HRMSTabView
...
class WorkAndShiftTabView(HRMSTabView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeIndividualNav(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestIndividualNav(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftAllocationIndividualNav(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class RotatingShiftIndividualNav(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class RotatingWorkIndividualNav(HRMSNavView):
    """
