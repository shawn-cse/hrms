...
@method_decorator(login_required, name="dispatch")
class RotatingShiftListParent(HRMSListView):
    """
    Parent class
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftAssignNav(HRMSNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftDetailview(HRMSDetailedView):
    """
    Detail View
    """
...
class RotatingShiftFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftAssignDuplicate(HRMSFormView):
    """
    Duplicate form view
    """
