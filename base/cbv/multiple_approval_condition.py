...
class MultipleApprovalConditionList(HRMSListView):
    """
...
class MultipleApprovalConditionNav(HRMSNavView):
    """
    Nav bar
    """
...
class MultipleApprovalConditionDetailView(HRMSDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MultipleApprovalConditionFormView(HRMSFormView):
    """
