...
@method_decorator(login_required, name="dispatch")
class WorkRequestListView(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkRequestNavView(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeDetailView(HRMSDetailedView):
    """
    Detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class DynamicWorkTypeCreateForm(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeDuplicateForm(HRMSFormView):
    """
    duplicate form
    """
