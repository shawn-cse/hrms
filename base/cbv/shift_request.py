...
@method_decorator(login_required, name="dispatch")
class ShitRequestNav(HRMSNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestTab(HRMSTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestDetailview(HRMSDetailedView):
    """
    Detail View
    """
...
class ShiftTypeFormView(HRMSFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestFormView(HRMSFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestFormDuplicate(HRMSFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftAllocationFormView(HRMSFormView):
    """
    Form View
    """
