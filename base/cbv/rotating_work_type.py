...
@method_decorator(login_required, name="dispatch")
class GeneralParent(HRMSListView):
    """
...
class RotatingWorkNavView(HRMSNavView):
    """
...
class RotatingWorkDetailView(HRMSDetailedView):
    """
    Detail view of page
    """
...
class RotatingWorkTypeFormView(HRMSFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.add_rotatingworktypeassign"), name="dispatch")
class RotatingWorkTypeDuplicateForm(HRMSFormView):
    """
    duplicate from view
    """
