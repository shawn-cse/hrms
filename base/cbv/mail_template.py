...
from hrms_views.generic.cbv.views import HRMSFormView, HRMSNavView


@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("base.add_hrmsmailtemplate"), name="dispatch")
class MailTemplateFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("base.add_hrmsmailtemplate"), name="dispatch")
class MailTemplateDuplicateForm(HRMSFormView):
    """
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        original_object = HRMSMailTemplate.objects.get(id=self.kwargs["pk"])
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("base.view_hrmsmailtemplate"), name="dispatch")
class MailTemplateNavView(HRMSNavView):
    """
