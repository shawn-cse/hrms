...
class DashboardWorkTypeRequest(WorkRequestListView):
    ...
    def get_queryset(self):
        ...
        queryset = HRMSListView.get_queryset(self)
...
class EmployeeWorkInformationList(HRMSListView):
    """
...
class EmployeeWorkInformationFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class DashboardAnnouncementView(HRMSListView):
    """
...
class AnnouncementViewedByList(HRMSListView):
    """
