...
class EmployeeShiftSheduleNav(HRMSNavView):
    """
...
class EmployeeShiftSheduleCreateForm(HRMSFormView):
    """
...
class EmployeeShiftSheduleList(HRMSListView):
...
@method_decorator(login_required, name="dispatch")
class EmployeeShiftSheduleDetailView(HRMSDetailedView):
    """
