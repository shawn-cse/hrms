...
from hrms.models import HRMSModel, NoPermissionModel, upload_path
...
class CompanyGroupAssignment(HRMSModel):
    """
...
class Roster(HRMSModel):
    ...
    objects = HRMSCompanyManager("employee__employee_work_info__company_id")
...
class ShiftRequest(HRMSModel):
    ...
    def user_availability(self):
        """
        This method for get custom column for HRMSUser availability.
        """
...
class MultipleApprovalManagers(models.Model):
    ...
    objects = HRMSCompanyManager(related_company_field="condition_id__company_id")
...
class AnnouncementView(models.Model):
    ...
    user = models.ForeignKey(HRMSUser, on_delete=models.CASCADE)
...
class IntegrationApps(HRMSModel, NoPermissionModel):
...
class DefaultExportPermission(HRMSModel):
    """
...
class CompanyLanguageSetting(HRMSModel):
    """
