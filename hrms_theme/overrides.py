...
Recruitment = get_hrms_model_class(app_label="recruitment", model="recruitment")
AttendanceLateComeEarlyOut = get_hrms_model_class(
...
Meetings = get_hrms_model_class(app_label="pms", model="Meetings")
ResignationLetter = get_hrms_model_class(
    app_label="offboarding", model="ResignationLetter"
)
AssetAssignment = get_hrms_model_class(app_label="asset", model="AssetAssignment")
TimeSheet = get_hrms_model_class(app_label="project", model="TimeSheet")
Deduction = get_hrms_model_class(app_label="payroll", model="Deduction")
Task = get_hrms_model_class(app_label="project", model="Task")
