...
@method_decorator(
    permission_required("hrms_theme.view_hrmscolortheme"),
    name="dispatch",
)
class ThemeView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["themes"] = HRMSColorTheme.objects.all()
        ...
        default_theme = HRMSColorTheme.get_default_theme()
...
@method_decorator(
    permission_required("hrms_theme.change_hrmscolortheme"),
    name="dispatch",
)
class ChangeThemeView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            theme = HRMSColorTheme.objects.get(pk=theme_id)
        ...
        except HRMSColorTheme.DoesNotExist:
    ...
    def _render_themes(self, request, active_theme=None, status=200):
        ...
        themes = HRMSColorTheme.objects.all()
        active_company = getattr(request, "active_company", None)
...
@method_decorator(
    permission_required("hrms_theme.add_hrmscolortheme"),
    name="dispatch",
)
