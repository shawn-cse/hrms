...
from hrms.models import HRMSModel, has_xss, upload_path
...
class Employee(models.Model):
    ...
    def get_history_col(self):
        ...
        HRMSModel-based list already gets automatically (see
        HRMSListView's history_tracking handling). Employee doesn't
        subclass HRMSModel, so it's added explicitly here instead.
        """
        return render_template(
...
class ProfileEditFeature(HRMSModel):
    """
    ProfileEditFeature
    """
