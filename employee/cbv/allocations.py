...
class AllocationView(HRMSDetailedView):
    """
    AllocationView
    """
...
class PersonalFormView(HRMSFormView):
    """
    PersonalFormView
    """
...
class WorkFormView(HRMSFormView):
    """
    WorkFormView
    """
...
class BankFormView(HRMSFormView):
    """
    WorkFormView
    """
...
if app_installed("asset"):
    ...
    class AssetAllocationList(HRMSListView):
        """
    ...
    class AssetCategoryAllocationList(HRMSListView):
        """
...
class Summary(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not instance_id:
            return HRMSRedirect(request, message=_("Employee ID missing."))
