...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsNav(HRMSNavView):
    """
    For nav bar
    """
...
class DynamicActionTypeFormView(HRMSFormView):
...
class DisciplinaryActionsFormView(HRMSFormView):
    """
    Form View
    """
...
class DisciplinaryActionsFormDuplicate(HRMSFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsDetailView(HRMSDetailedView):
    """
    detail view of page
    """
