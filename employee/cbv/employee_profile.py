...
from hrms_views.generic.cbv.views import HRMSDetailedView, HRMSProfileView

Employee.cbv_employee_profile_edi_url = reverse_lazy("edit-profile")


@method_decorator(login_required, name="dispatch")
class EmployeeProfileView(HRMSProfileView):
    """
    EmployeeProfileView
    """
...
class EmployeeRelatedDetailView(HRMSDetailedView):
    """
