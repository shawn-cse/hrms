...
@method_decorator(login_required, name="dispatch")
class MainParentListView(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestNavView(HRMSNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestDetailView(HRMSDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestForm(HRMSFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestSingleForm(HRMSFormView):
    """
