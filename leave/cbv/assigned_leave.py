...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedleaveList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedLeaveNavView(HRMSNavView):
    """
    navbar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedLeaveDetailView(HRMSDetailedView):
    """
    detail view
    """
...
# not done
class AssignedLeaveFormView(HRMSFormView):
    """
    form view
    """
