...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeListView(HRMSListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeNavView(HRMSNavView):
    """
    navbar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeDetailView(HRMSDetailedView):
    """
    detail view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeCardView(HRMSCardView):
    """
    card view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeAssignForm(HRMSFormView):
    """
    form view
    """
