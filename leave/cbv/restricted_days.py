...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysNav(HRMSNavView):
    """
    Nav bar
    """
...
class RestrictedDaysFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysDetailView(HRMSDetailedView):
    """
    detail view of page
    """
