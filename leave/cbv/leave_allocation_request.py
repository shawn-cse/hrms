...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestTab(HRMSTabView):
    """
    Tab View
    """
...
class _LeaveAllocationTabNavBase(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestDetailView(HRMSDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestFormView(HRMSFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationBulkFormView(HRMSFormView):
    """
