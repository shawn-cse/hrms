...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryListView(HRMSListView):
    """
...
class _CompensatoryTabNavBase(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryLeaveTabView(HRMSTabView):
    """
    tabview of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryGenericDetailView(HRMSDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryForm(HRMSFormView):
    """
    for view
    """
...
# class CompensatoryRejectForm(HRMSFormView):
#     """
#     for view
#     """
