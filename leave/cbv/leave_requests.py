...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_leaverequest"), name="dispatch")
class LeaveRequestsListView(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_leaverequest"), name="dispatch")
class LeaveRequestsNavView(HRMSNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_leaverequest"), name="dispatch")
class LeaveRequestsDetailView(HRMSDetailedView):
    """
    detail view of page
    """
...
class LeaveRequestFormView(HRMSFormView):
    """
    form view
    """
