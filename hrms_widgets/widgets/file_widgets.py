...
HRMS shows a clean display name instead of hrms.models.upload_path's
...
def patch_clearable_file_input():
    ...
    point its template at the HRMS override.
    """
    ...
    forms.ClearableFileInput.template_name = (
        "hrms_widgets/hrms_clearable_file_input.html"
    )
