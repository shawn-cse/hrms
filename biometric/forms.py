...
from hrms_widgets.forms import default_select_option_template
...
class DahuaUserForm(Form):
    """
    This form is used to map a HRMS employee to a user entry on a Dahua biometric device.
    """
...
class MapBioUsers(ModelForm):
    """
    Form for mapping biometric users to HRMS employees.

    This form is used to associate a biometric user (from a biometric device) with
    an employee in the HRMS system.
    """
