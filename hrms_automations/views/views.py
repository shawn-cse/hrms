...
from hrms_automations.signals import REFRESH_METHODS
...
@login_required
@permission_required("hrms_automations.delete_mailautomation")
...
@login_required
@permission_required("hrms_automations.view_mailautomation")
def mail_automations_settings_view(request):
    ...
    return render(
        request,
        "hrms_automations/mail_automations_settings.html",
    )


@login_required
@hx_request_required
@permission_required("hrms_automations.add_mailautomation")
