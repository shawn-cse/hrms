 ...
 * auto-start tour, and exposes window.hrmsTour.toggle() so the "?" navbar
 * button can open/close the launcher panel.
 *
 * Depends on:
 *   - driver.js  (already on window.driver.js.driver)
 *   - window.HRMS_TOUR  set by footer_scripts.html
 */
(function () {
  'use strict';

  var CFG = window.HRMS_TOUR || {};
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // Automatic tour popups disabled
  });
})();
