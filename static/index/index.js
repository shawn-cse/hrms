...
// programmatic htmx.ajax() calls (e.g. HRMSTabView's tab-content loads)
...
/**
 * Clear list-row selections when switching HRMS tabs. Lists may use a
...
// checked in hrms_list_table.html / group_by_table.html's
...
function toggleColumnVisibility(checkboxEl, fieldName, visible) {
    // Scope to this list only. HRMSTabView keeps visited tabs in the DOM,
 ...
 * form's hx-get for list/card views, and HRMSTabView's own tab-content
