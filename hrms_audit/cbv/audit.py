...
from hrms_audit.filters import AudiTagFilter
...
@method_decorator(permission_required("hrms_audit.view_audittag"), name="dispatch")
class AudiTagsList(HRMSListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("hrms_audit.view_audittag"), name="dispatch")
class AuditTagsNavView(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("hrms_audit.add_audittag"), name="dispatch")
class AuditTagCreateForm(HRMSFormView):
    """
