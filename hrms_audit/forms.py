...
from hrms_audit.models import AuditModelConfig, AuditTag, HRMSAuditInfo
...
def _eligible_models():
    """Return concrete HRMSModel subclasses that can be audit-tracked."""
    ...
    for model in django_apps.get_models():
        if not issubclass(model, HRMSModel) or model._meta.abstract:
            continue
