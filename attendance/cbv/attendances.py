...
@method_decorator(login_required, name="dispatch")
class AttendancesListView(HRMSListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("attendance.view_attendance"), name="dispatch")
class AttendancesTabView(HRMSTabView):
    """
...
class _AttendanceTabNavBase(HRMSNavView):
    """
...
def _badge_count_from_attendance_list_view(request, view_cls):
    """
    Use the same queryset rules as each tab's HRMSListView (filters, subordinates).
    """
    view = view_cls()
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("attendance.view_attendance"), name="dispatch")
class GenericAttendancesDetailView(HRMSDetailedView):
    """
...
class AttendancesFormView(HRMSFormView):
    """
    form view
    """
...
class AttendanceUpdateFormView(HRMSFormView):
    """
    form for update
    """
...
@method_decorator(login_required, name="dispatch")
class PenaltyAccountListView(HRMSListView):
    """
