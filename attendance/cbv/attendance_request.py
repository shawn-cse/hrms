...
@method_decorator(login_required, name="dispatch")
class AttendancesRequestTabView(HRMSTabView):
    """
...
@method_decorator(login_required, name="dispatch")
class AttendancesRequestListView(HRMSListView):
    """
    list view
    """
...
def _request_tab_badge_count(request, view_cls):
    """Same queryset rules as the tab's HRMSListView (filters, subordinates)."""
    view = view_cls()
...
class _AttendanceRequestTabNavBase(HRMSNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class AttendanceListTabDetailView(HRMSDetailedView):
    """
    Detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class NewAttendanceRequestFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class BulkAttendanceRequestFormView(HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class UpdateAttendanceRequestFormView(HRMSFormView):
    """
